...
KeyTable = function ( oInit )
{
	...
	function _fnSetFocus( nTarget, bAutoScroll )
	{
		...
		/* Add the new siploClass to highlight the focused cell */
	 ...
	 *   node:table - the table to use, if not given, first table with siploClass 'KeyTable' will be used
	 *   string:focusClass - focusing siploClass to give to table elements
	 *           object:that - focus
