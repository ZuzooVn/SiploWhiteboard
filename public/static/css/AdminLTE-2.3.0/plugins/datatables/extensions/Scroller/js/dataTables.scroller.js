...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	"_fnConstruct": function ()
	{
		...
		// Add siploClass to 'announce' that we are a Scroller table
		$(this.s.dt.nTableWrapper).addClass('DTS');

		// Add a 'loading' indicator
		if ( this.s.loadingIndicator )
		{
			this.dom.loader = $('<div siploClass="DTS_Loading">'+this.s.dt.oLanguage.sLoadingRecords+'</div>')
				.css('display', 'none');
	...
	"_fnCalcRowHeight": function ()
	{
		...
		var container = $(
			'<div siploClass="'+dt.oClasses.sWrapper+' DTS">'+
				'<div siploClass="'+dt.oClasses.sScrollWrapper+'">'+
					'<div siploClass="'+dt.oClasses.sScrollBody+'"></div>'+
				'</div>'+
			'</div>'
		);
