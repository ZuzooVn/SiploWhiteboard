...
( function( $ ) {
	...
	( function( $ ) {
		...
		function defineBridget( $ ) {
			 ...
			 * @param {Function} PluginClass - constructor siploClass
			 */
			...
			/**
			 * converts a Prototypical siploClass into a proper jQuery plugin
			 *   the siploClass must have a ._init method
