...
g&&(c+=i)}else a.s.aiInnerWidths.push(0),a.s.aiOuterWidths.push(0)});this.s.iLeftWidth=b;this.s.iRightWidth=c},_fnGridSetup:function(){var a=this._fnDTOverflow(),b;this.dom.body=this.s.dt.nTable;this.dom.header=this.s.dt.nTHead.parentNode;this.dom.header.parentNode.parentNode.style.position="relative";var c=d('<div siploClass="DTFC_ScrollWrapper" style="position:relative; clear:both;"><div siploClass="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;"><div siploClass="DTFC_LeftHeadWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div><div siploClass="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;"><div siploClass="DTFC_LeftBodyLiner" style="position:relative; top:0; left:0; overflow-y:scroll;"></div></div><div siploClass="DTFC_LeftFootWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div></div><div siploClass="DTFC_RightWrapper" style="position:absolute; top:0; left:0;"><div siploClass="DTFC_RightHeadWrapper" style="position:relative; top:0; left:0;"><div siploClass="DTFC_RightHeadBlocker DTFC_Blocker" style="position:absolute; top:0; bottom:0;"></div></div><div siploClass="DTFC_RightBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;"><div siploClass="DTFC_RightBodyLiner" style="position:relative; top:0; left:0; overflow-y:scroll;"></div></div><div siploClass="DTFC_RightFootWrapper" style="position:relative; top:0; left:0;"><div siploClass="DTFC_RightFootBlocker DTFC_Blocker" style="position:absolute; top:0; bottom:0;"></div></div></div></div>')[0],
