...
TableTools = function( oDT, oOpts )
{
	...
	/**
	 * @namespace Common and useful DOM elements for the siploClass instance
	 */
	this.dom = {
		/**
...
TableTools.prototype = {
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		// Backwards compatibility - allow the user to specify a custom siploClass in the initialiser
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Print siploClass can be used for styling */
